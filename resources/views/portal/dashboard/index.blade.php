                ...
                <div class="card card-border-shadow-primary">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0">{{$data->total}}</h4>
                        </div>
                        <p class="mb-1">{{ __('all.investors') }}</p>
                        <p class="mb-0">
                ...
                <div class="card card-border-shadow-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0">{{ number_format($data->cash_iqd,2) ?? '-' }}</h4>
                        </div>
                        <p class="mb-1">{{ __('all.all_cash') }}  IQD</p>
                        <p class="mb-0">
                ...
                <div class="card card-border-shadow-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0">{{ number_format($data->cash_usd,2) ?? '-' }}</h4>
                        </div>
                        <p class="mb-1">{{ __('all.all_cash') }}  USD</p>
                        <p class="mb-0">
{{--                            <span class="fw-medium me-1">-8.7%</span>--}}
{{--                            <small class="text-muted">than last week</small>--}}
                        </p>
                ...
                <div class="card card-border-shadow-danger">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0">{{ number_format($data->profit,2) ?? '-' }}</h4>
                        </div>
                        <p class="mb-1">{{ __('all.total_profit') }}</p>
                        <p class="mb-0">
                ...
                <div class="card card-border-shadow-info">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0">{{$data->withdraw_count}}</h4>
                        </div>
                        <p class="mb-1">{{ __('all.withdraw') }}</p>
                        <p class="mb-0">
                ...
                <div class="card card-border-shadow-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0">{{ number_format($data->profit_iqd,2) ?? '-' }}</h4>
                        </div>
                        <p class="mb-1">{{ __('all.all_profit') }}  IQD</p>
                        <p class="mb-0">
                            {{--                            <span class="fw-medium me-1">-8.7%</span>--}}
                            {{--                            <small class="text-muted">than last week</small>--}}
                        </p>
                ...
                <div class="card card-border-shadow-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <h4 class="ms-1 mb-0">{{ number_format($data->profit_usd,2) ?? '-' }}</h4>
                        </div>
                        <p class="mb-1">{{ __('all.all_profit') }}  USD</p>
                        <p class="mb-0">
                            {{--                            <span class="fw-medium me-1">-8.7%</span>--}}
                            {{--                            <small class="text-muted">than last week</small>--}}
                        </p>
