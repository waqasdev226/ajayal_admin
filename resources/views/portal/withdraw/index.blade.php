                        ...
                        <table class="datatables-customers table border-top dataTable no-footer dtr-column" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                            ...
                            @foreach($data as $row)
                                <tr>
                                    ...
                                    <td class="text-sm">{{ number_format($row->userDetail->profit,2) ?? '-' }} - {{ $row->userDetail->currency ?? '-' }}</td>
                                    <td class="text-sm">{{ number_format($row->amount,2) ?? '-' }}</td>
                                    <td class="text-sm">{{ $row->method ?? '-' }}</td>
                                ...
                                <div  class="modal fade" id="investorEdit{{$row->id}}" tabindex="-1" aria-hidden="true">
