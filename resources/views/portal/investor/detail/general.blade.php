        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="card-info">
                        <h4 class="card-title mb-3">{{ __('all.cash') }}</h4>
                        <div class="d-flex align-items-baseline mb-1 gap-1">
                            <h4 class="text-primary mb-0">{{ number_format($data->cash,2) }} - {{ $data->currency }}</h4>
                        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-info">
                        <h4 class="card-title mb-3">{{ __('all.total_profit') }}</h4>
                        <div class="d-flex align-items-baseline mb-1 gap-1">
                            <h4 class="text-info mb-0">{{ number_format($data->total_profit,2) }}</h4>
                        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="card-info">
                        <h4 class="card-title mb-3">{{ __('all.profit') }}</h4>
                        <div class="d-flex align-items-baseline mb-1 gap-1">
                            <h4 class="text-success mb-0">{{ number_format($data->profit,2) }}</h4>
                        </div>
        ...
        <div class="table-responsive mb-3">
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                <div class="card-header flex-column flex-md-row py-2">
                    <div class="head-label text-center pt-2 pt-md-0"><h5 class="card-title mb-0 text-nowrap">{{__('all.list').' '.__('all.transaction')}}</h5></div>
